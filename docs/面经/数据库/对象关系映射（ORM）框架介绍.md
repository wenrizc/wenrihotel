...
### 1.2. 运行时SQL生成与执行 (SQL Generation and Execution)
...
### 1.4. 持久化上下文 (Persistence Context) / 会话 (Session)
...
### 1.5. 关联关系处理 (Association Handling)
